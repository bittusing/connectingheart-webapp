  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const updatePayload: any = {
        ...
        // Always send brothers/sisters as string, including "0" for None
        brothers: String(formData.brothers),
        marriedBrothers: String(formData.marriedBrothers),
        sisters: String(formData.sisters),
        marriedSisters: String(formData.marriedSisters),
