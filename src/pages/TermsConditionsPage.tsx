...
const companyRoleBullets = [
  ...
  'Connecting Heart\'s obligation is only to provide an interface to its registered members to search their prospect themselves without any assistance.',
...
export const TermsConditionsPage = () => {
  return (
    <section className="space-y-8">
      ...
      <article className={sectionClass}>
        <h2 className="text-xl font-semibold text-slate-900 dark:text-white">Class Action Suits</h2>
        <p className="mt-4 text-sm leading-relaxed text-slate-600 dark:text-slate-400">
